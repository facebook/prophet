...
On Windows, PyStan requires a compiler so you'll need to [follow the instructions](https://pystan.readthedocs.io/en/latest/faq.html#is-windows-supported). The easiest way to install Prophet in Windows is in Anaconda.
